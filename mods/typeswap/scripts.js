exports.BattleScripts = {
        init: function() {
                        for (var i in this.data.Learnsets) {
                                if (i in normal) {
        	                        this.modData('Pokedex', i).types = ['Ghost'];                                        
                                        ...
                                        this.modData('Pokedex', i).types = ['Water'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Fire'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Grass'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Dark'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Flying'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Steel'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Dragon'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Rock'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Psychic'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Fighting'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Ground'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Ice'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Normal'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Electric'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Poison'];  
                                        ...
                                        this.modData('Pokedex', i).types = ['Bug'];  
